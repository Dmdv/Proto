...
en4.music.playlistAbstract = new Class({
  ...
  _attachEvents : function() {
	...
	// replay
	var replay;
    this.container.getElement('.music_player_button_replay').addEvent('click', function(event) {
	this.container.getElement('.music_player_button_replay').toggleClass('music_player_button_alwaysplay');
    return false;
    }.bind(this)
	...
	// display player
	this.container.getElements('.playerdisplay').addEvent('click', function(event) {
	
	this.container.getElement('.music_player_top').addClass('di');
    ...
    // tracks
    this.container.getElements('ul.music_player_tracks li .music_player_button_playlist').addEvent('click', function(event) {
      var el;
      if( !event ||
          !('target' in event) ||
          !(el = $(event.target)) ||
    ...
    this.addEvents({
	 ...
	 soundmanager_replay : function() {
      ...
      this.container.getElement('.music_player_button_play').removeClass('music_player_button_pause');
	if(this.container.getElement('.music_player_button_alwaysplay')){this.play();}else{this.playNext();}
      event.stop();
      return false;
      }.bind(this),
