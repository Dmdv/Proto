...
<div class="summary_wrap clear_fix">
  ...
  <div id="summary" class="summary">
    <span id="mail_summary">{if $total_pms == 0}Ваша папка "Отправленные" пуста.{else}Вы отправили {$total_pms} сообщений{/if}</span>
  </div>
</div>
  {/if}
...
{/if}
  ...
  <div id="mail_summary_progress" class="fl_r"><img src="/images/upload.gif" /></div>
  <div id="summary" class="summary">
    <span id="mail_summary">Ваша папка "Отправленные" пуста.</span>
  </div>
</div>{/if}
...
{if $total_pms == 0}
		...
		<div id="nomail">Вы не отправили ни одного сообщения.</div>
		</div>
  </div>
  </div>
...
<table id="mail_rows_t" cellpadding="0" cellspacing="0">
  ...
  <td class="mail_photo">
    <div><a href='{$url->url_create('profile', $pms[pm_loop].pm_user->user_info.user_username)}'><div class="avasmall2">
<div class="avasmall"><img src='{$pms[pm_loop].pm_user->user_photo('./images/camera_c.gif', TRUE)}'/></div>
</div></a></div>
  </td>
  <td class="mail_from">
    <div class="name wrapped"><a href='{$url->url_create('profile', $pms[pm_loop].pm_user->user_info.user_username)}'>{$pms[pm_loop].pm_user->user_displayname}</a></div>
  ...
  <td class="mail_contents" id="mb15983">
    <div class="mail_topic"><a href='user_messages_view.php?pmconvo_id={$pms[pm_loop].pmconvo_id}#bottom'>{$pms[pm_loop].pm_subject|truncate:70}</a></div>
    <div class="mail_body"><a href='user_messages_view.php?pmconvo_id={$pms[pm_loop].pmconvo_id}#bottom'>{$pms[pm_loop].pm_body|truncate:70|choptext:60:"<br>"}</a></div>
  </td>
  <td class="messageActions" id="ma431351693"><span></span><div>
      <a href='user_messages_view.php?pmconvo_id={$pms[pm_loop].pmconvo_id}#bottom'>Ответить</a><br /><br />
