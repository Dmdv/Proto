...
<form action="admin_wall.php" method="post">
    ...
    <thead>
        <tr>
            <td class="header" colspan="2"><a href="javascript://"  title="{lang_print id=690706130}"onclick="$(this).getParent('table').getElement('tbody').toggleClass('display_none'); this.blur();">{lang_print id=690706035}</a></td>
        </tr>
    </thead>
    <tbody {if !$result}class="display_none"{/if}>
        ...
        <tr class="{cycle values=',bg1'}">
            <td class="item">{lang_print id=690706179}</td>
            <td class="item"><input type="checkbox" value="1" name="setting_he_wall_disable_music" {if $setting.setting_he_wall_disable_music}checked="checked"{/if}/></td>
        </tr>
    ...
    <thead>
        <tr>
            <td class="header"><a href="javascript://"  title="{lang_print id=690706130}"onclick="$(this).getParent('table').getElement('tbody').toggleClass('display_none'); this.blur();">{lang_print id=690706107}</a></td>
        </tr>
    </thead>
    <tbody {if !$result}class="display_none"{/if}>
        <tr class="{cycle values=',bg1'}">
    ...
    <thead>
        <tr>
            <td class="header"><a href="javascript://" title="{lang_print id=690706130}" onclick="$(this).getParent('table').getElement('tbody').toggleClass('display_none'); this.blur();">{lang_print id=690706113}</a></td>
        </tr>
    </thead>
    <tbody {if !$result}class="display_none"{/if}>
        <tr class="{cycle values=',bg1'}">
    ...
    <thead>
        <tr>
            <td class="header"><a href="javascript://" title="{lang_print id=690706130}" onclick="$(this).getParent('table').getElement('tbody').toggleClass('display_none');  this.blur();">{lang_print id=690706123}</a></td>
        </tr>
    </thead>
    <tbody {if !$result}class="display_none"{/if}>
        <tr class="{cycle values=',bg1'}">
    ...
    <thead>
        <tr>
            <td colspan="2" class="header"><a href="javascript://"  title="{lang_print id=690706130}" onclick="$(this).getParent('table').getElement('tbody').toggleClass('display_none'); this.blur();">{lang_print id=690706177}</a></td>
        </tr>
    </thead>
    <tbody {if !$result} class="display_none" {/if}>
        <tr class="{cycle values=',bg1'}">
            <td class="item">
                <input type="checkbox" name="setting_he_wall_search_advanced" {if $setting.setting_he_wall_search_advanced == 1} CHECKED {/if} value="1" />
            </td>
            <td class="item">
                {lang_print id=690706175}
            </td>
        </tr>
        <tr class="{cycle values=',bg1'}">
            <td class="item">
                <input type="checkbox" name="setting_he_wall_status_change" {if $setting.setting_he_wall_status_change == 1} CHECKED {/if} value="1" />
            </td>
            <td class="item">
                {lang_print id=690706176}
            </td>
        </tr>
    </tbody>
    </table>
...
<br/>
<br/>
<h2 onclick="$('wall_snippet_code').toggleClass('display_none');" title="{lang_print id=690706130}" class="wall_snippet_code_btn">{lang_print id=690706103}</h2>
<div id="wall_snippet_code" class="display_none">
...
<h2 onclick="$('user_status_snippet_code').toggleClass('display_none');" title="{lang_print id=690706130}" class="wall_snippet_code_btn">{lang_print id=690706191}</h2>
<div id="user_status_snippet_code" class="display_none">
	{lang_print id=690706192}<br />
	<br/>
	
	<b>{lang_print id=690706193}</b>
	<div class="code_preview">
	{ldelim}he_wall_display_status owner=$owner{rdelim}
	</div>
	
	<b>{lang_print id=690706194}</b>
	<div class="code_preview" style="background-color: #FFFCDF">
	{literal}
		<span>{* JAVASCRIPT FOR SWITCHING TABS *}</span>
	{/literal}
	</div>
	
	<b>{lang_print id=690706195}</b>
	<div class="code_preview" style="font-size:15px; font-weight:bold; background-color:#FFF0EF; border-color:#FF7F9C;">
	{literal}
		<span>&lt;div class='page_header'&gt;{lang_sprintf id=786 1=$owner-&gt;user_displayname}&lt;/div&gt;</span>
	{/literal}
	</div>
</div>
