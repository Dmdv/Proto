...
<div class="clearFix tBar">
     <ul class="tabs" id="friendTabs" style="width:595px;float:left;">
...
<li class="activeLink"><a href='user_messages_settings.php'style="width:12em">{$user_messages_settings3}</a></li>
</ul>
