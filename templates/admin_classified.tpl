...
{* $Id: admin_classified.tpl 7 2009-01-11 06:01:49Z john $ *}

<h2>{lang_print id=4500077}</h2>
{lang_print id=4500078}
<br />
<br />
...
<form action='admin_classified.php' method='post'>
...
<table cellpadding='0' cellspacing='0' width='600'>
  ...
  <tr>
    <td class='setting1'>{lang_print id=4500079}</td>
  </tr>
  <tr>
    <td class='setting2'>
      <table cellpadding='2' cellspacing='0'>
        <tr>
          <td><input type='radio' name='setting_permission_classified' id='setting_permission_classified_1' value='1'{if  $setting.setting_permission_classified} checked{/if} /></td>
          <td><label for='setting_permission_classified_1'>{lang_print id=4500080}</label></td>
        </tr>
        <tr>
          <td><input type='radio' name='setting_permission_classified' id='setting_permission_classified_0' value='0'{if !$setting.setting_permission_classified} checked{/if} /></td>
          <td><label for='setting_permission_classified_0'>{lang_print id=4500081}</label></td>
        </tr>
      </table>
    </td>
  </tr>
...
<table cellpadding='0' cellspacing='0' width='600'>
  <tr>
    <td class='header'>{lang_print id=4500082}</td>
  </tr>
  <tr>
    <td class='setting1'>{lang_print id=4500083}</td>
  </tr>
  <tr>
    <td class='setting2'>
      ...
      <div style='font-weight: bold;'>
        &nbsp;
        {lang_print id=4500084} - <a href='javascript:addcat();'>[{lang_print id=104}]</a>
      </div>
      ...
      <div id='categories' style='padding-left: 5px; font-size: 8pt;'>
        ...
        <div id='cat_{$cats[cat_loop].cat_id}'>
          ...
          <div style='padding-left: 20px; padding-top: 5px; padding-bottom: 3px;'>
            {lang_print id=100} - 
            <a href='admin_fields.php?type=classified&task=addfield&cat_id={$cats[cat_loop].cat_id}&hideSearch=0&hideDisplay=1&hideSpecial=1&TB_iframe=true&height=450&width=450' class='smoothbox' title='{lang_print id=101}'>[{lang_print id=101}]</a>
          </div>
          ...
          <div id='fields_{$cats[cat_loop].cat_id}' style='padding-left: 20px;'>
            ...
            <div id='field_{$cats[cat_loop].fields[field_loop].field_id}' style='padding-left: 15px; padding-bottom: 3px;'>
              <div>
                ...
                <a href='admin_fields.php?type=classified&task=getfield&field_id={$cats[cat_loop].fields[field_loop].field_id}&hideSearch=0&hideDisplay=1&hideSpecial=1&TB_iframe=true&height=450&width=450' class='smoothbox' title='{lang_print id=140}'>{lang_print id=$cats[cat_loop].fields[field_loop].field_title}</a>
              </div>
