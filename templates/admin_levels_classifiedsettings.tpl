...
{* $Id: admin_levels_classifiedsettings.tpl 16 2009-01-13 04:01:31Z john $ *}
    ...
    <tr>
      <td class='setting2'>
        <table cellpadding='0' cellspacing='0'>
          <tr>
            <td><input type='radio' name='level_classified_allow' id='level_classified_allow_1' value='1'{if  $level_info.level_classified_allow} checked{/if} />&nbsp;</td>
            <td><label for='level_classified_allow_1'>{lang_print id=4500015}</label></td>
          </tr>
          <tr>
            <td><input type='radio' name='level_classified_allow' id='level_classified_allow_0' value='0'{if !$level_info.level_classified_allow} checked{/if} />&nbsp;</td>
            <td><label for='level_classified_allow_0'>{lang_print id=4500016}</label></td>
          </tr>
        </table>
      </td>
    </tr>
