...
{* $Id: user_upload.tpl 204 2009-07-29 00:51:39Z john $ *}
...
{/literal}
  ...
  {if $file_result|@count != 0}
              ...
              <div class='msg'>Аудиозапись успешно загружена.</div>
...
<div id='fallback'>
  ...
  <form action='user_music_upload.php' method='POST' enctype='multipart/form-data' id='uploadForm' onSubmit='startStatus()'>

    <div id='div1'>
      <table cellpadding='0' cellspacing='0' class='form'>
      <tr>
      <td class='form1' width='65'>Файл:</td>
      <td class='form2'><input type='file' name='file1' size='30' class='text' onchange="$('div2').style.display = 'block';$('div_submit').style.display = 'block';"></td>
      </tr>
      </table>
    </div>
    ...
    <div id='div2' style='display: none;'>
      ...
      <tr>
      <td class='form1' width='65'>Файл:</td>
      <td class='form2'><input type='file' name='file2' size='30' class='text' onchange="$('div3').style.display = 'block';"></td>
      </tr>
      </table>
    </div>
    ...
    <div id='div3' style='display: none;'>
      ...
      <tr>
      <td class='form1' width='65'>Файл:</td>
      <td class='form2'><input type='file' name='file3' size='30' class='text' onchange="$('div4').style.display = 'block';"></td>
      </tr>
      </table>
    </div>
    ...
    <div id='div4' style='display: none;'>
      ...
      <tr>
      <td class='form1' width='65'>Файл:</td>
      <td class='form2'><input type='file' name='file4' size='30' class='text' onchange="$('div5').style.display = 'block';"></td>
      </tr>
      </table>
    </div>
    ...
    <div id='div5' style='display: none;'>
      <table cellpadding='0' cellspacing='0' class='form'>
      <tr>
      <td class='form1' width='65'>File 5:</td>
      <td class='form2'><input type='file' name='file5' size='30' class='text'></td>
      </tr>
      </table>
    </div>
     <br>
    <div id='div_submit'>
      ...
      <td class='form1'> <ul class="nNav clearFix">

   <ul class="nNav clearFix">
<div class="button_blue fl_l">
        <button type='submit' id='fallback_submit'>Загрузить</button></div></div>
        ...
        <input type='hidden' name='MAX_FILE_SIZE' value='false'>
	      </td>
