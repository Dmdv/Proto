...
<div style='text-align:left; padding: 10px;'>
  ...
  {include file='user_upload2.tpl' action='user_group_upload.php' session_id=$session_id upload_token=$upload_token show_uploader=$show_uploader inputs=$inputs file_result=$file_result}
