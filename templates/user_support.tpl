...
{if $supports[support_loop].support_status == '1' }
  <a class="fl_r tu_last" href="support?act=show&id={$supports[support_loop].support_id}" onclick="return Tickets.gotoTicket({$supports[support_loop].support_id}, this, event);">
    ...
    <div class="fl_l tu_mem">Сотрудник поддержки #1</div>
...
<div id="reply{$comments[comment_loop].comment_id}"><div class="tickets_reply_row clear_fix first">
    <div class="tickets_image fl_l">
      <a onclick="return nav.go(this, event);" ><img height="50" src="{if $comments[comment_loop].comment_author->user_info.user_id == '2' }/images/support_1.png {else}/images/support_1.png{/if}" width="50" /></a>
      
    </div>
    <div class="tickets_reply_content fl_l">
      <div class="tickets_reply_title">
        <span class="tickets_author"><a class="mem_link" >
{if $comments[comment_loop].comment_author->user_info.user_id == '2' }Сотрудник поддержки #2{else}Сотрудник поддержки #1{/if}
</a></span>
      </div>
      <div class="tickets_reply_text">
...
{else}
     <div id="reply{$comments[comment_loop].comment_id}"><div class="tickets_reply_row clear_fix first">
    <div class="tickets_image fl_l">
      <a onclick="return nav.go(this, event);" ><img height="50" src="{if $comments[comment_loop].comment_author->user_info.user_photo == '' }/images/camera_c.gif{else}{$comments[comment_loop].comment_author->user_info.user_photo}{/if}" width="50" /></a>
...
<link type="text/css" rel="stylesheet" href="/css/al/tickets.css?61"></link>
  {literal} <div id="page_body" class="fl_r" style="width: 631px;">
      <div id="header_wrap2">
        <div id="header_wrap1">
          <div id="header" style="display: none">
            <h1 id="title"></h1>
...
<div id="tickets_reply_rows">
  <div id="reply{$support}"><div class="tickets_reply_row clear_fix first">
    <div class="tickets_image fl_l">
      <a href="id{$user->user_info.user_id}" onclick="return nav.go(this, event);"   ><img  height="50" width="50" src="{$user->user_photo("./images/camera_c.gif")}" /></a>
...
{else}
     <div id="reply{$comments[comment_loop].comment_id}"><div class="tickets_reply_row clear_fix first">
    <div class="tickets_image fl_l">
      <a onclick="return nav.go(this, event);" ><img height="50" src="{$comments[comment_loop].comment_author->user_photo('./images/camera_c.gif', 1)}" width="50" /></a>
...
if (browser.chrome) {
  setStyle(ts_input, {padding: (vk.rtl ? '4px 23px 3px 2px' : '4px 3px 3px 23px')});
} </script> <div id="page_body" class="fl_r" style="width: 631px;">
      <div id="header_wrap2">
        <div id="header_wrap1">
          <div id="header" style="display: none">
            <h1 id="title"></h1>
...
<div id="tickets_post_field_wrap"><div id="tickets_post_field" class="clear_fix">
  <div class="tickets_image fl_l">
    <a href="anton_o_o" onclick="return nav.go(this, event);"><img height="50" width="50"  src="{$user->user_photo("./images/camera_c.gif")}" /></a>
  </div>
  <div id="tickets_post_form" class="fl_l">
...
{if $supports[support_loop].support_status == '1' }
  <a class="fl_r tu_last" href="support?act=show&id={$supports[support_loop].support_id}" onclick="return Tickets.gotoTicket({$supports[support_loop].support_id}, this, event);">
    ...
    <div class="fl_l tu_thumb"><img class="tu_img" src="{$user->user_photo("./images/camera_c.gif")}" /></div>
