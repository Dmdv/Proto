...
{* $Id: admin_viewclassifieds.tpl 7 2009-01-11 06:01:49Z john $ *}
...
{else}
  ...
  <table cellpadding='0' cellspacing='0' class='list'>
    ...
    <tr class='{cycle values="background1,background2"}'>
      ...
      <td class='item'>
        {* $datetime->cdate($setting.setting_dateformat, $datetime->timezone($classifieds[classified_loop].classified->classified_info.classified_date, $setting.setting_timezone)) *}
      </td>
      <td class='item'>
